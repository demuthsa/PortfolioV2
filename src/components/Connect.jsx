  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full max-w-6xl">
        <div className="flex flex-col gap-16 mb-16 text-center md:flex-row">
          <motion.div
            className="flex-1"
            variants={fadeIn}
            transition={{ duration: 0.6, delay: 0.4 }}
          >
            <h3 className="mb-8 text-4xl font-bold text-[#FF9E8A]">
              offer job opportunity?
            </h3>
            <p className="text-2xl text-gray-200 bg-[#1c3d5a99] p-6 rounded-md">
      ...
      <div className="flex gap-20 mt-20 text-center">
        <motion.a 
          href="mailto:demuths@oregonstate.edu" 
          className="text-6xl text-white hover:text-[#FF9E8A]"
          variants={fadeIn}
