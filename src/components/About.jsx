  ...
  return (
    ...
    >
      <div className="container mx-auto text-center">
        <motion.h1
          className="mb-32 text-5xl font-extrabold tracking-wide text-center text-white uppercase drop-shadow-lg"
          variants={fadeInUp}
        ...
        <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:gap-16">
          ...
          >
            <h3 className="mb-6 text-4xl font-extrabold text-[#FF9E8A]">Past</h3>
            <p className="text-2xl text-gray-200 leading-snug bg-[#1c3d5a99] p-6 rounded-md w-full">
          ...
          >
            <h3 className="mb-6 text-4xl font-extrabold text-[#FF9E8A]">Present</h3>
            <p className="text-2xl text-gray-200 leading-snug bg-[#1c3d5a99] p-6 rounded-md w-full">
        ...
        <div className="flex flex-col items-center justify-center mt-20 md:mt-24">
          ...
          >
            <h3 className="mb-6 text-4xl font-extrabold text-[#FF9E8A]">Future</h3>
            <p className="text-2xl text-gray-200 leading-snug bg-[#1c3d5a99] p-6 rounded-md w-full">
